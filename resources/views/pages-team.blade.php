                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="px-1 pt-1">
                                            <div class="modal-team-cover position-relative mb-0 mt-n4 mx-n4 rounded-top overflow-hidden">
                                                <img loading="lazy" src="{{URL::asset('build/images/small/img-9.jpg')}}" alt="" id="cover-img" class="img-fluid">
                                            ...
                                            <div class="position-relative d-inline-block">
                                                ...
                                                <div class="avatar-lg">
                                                    <div class="avatar-title bg-light rounded-circle">
                                                        <img loading="lazy" src="{{URL::asset('build/images/users/user-dummy-img.jpg')}}" id="member-img" class="avatar-md rounded-circle h-auto" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <button type="submit" data-submit-protect="true" class="btn btn-success" id="addNewMember">Add Member</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="member-overview">
                ...
                <div class="offcanvas-body profile-offcanvas p-0">
                    <div class="team-cover">
                        <img loading="lazy" src="{{URL::asset('build/images/small/img-9.jpg')}}" alt="" class="img-fluid" />
                    </div>
                    <div class="p-3">
                    ...
                    <div class="p-3 text-center">
                        <img loading="lazy" src="{{URL::asset('build/images/users/avatar-2.jpg')}}" alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto profile-img">
                        <div class="mt-3">
