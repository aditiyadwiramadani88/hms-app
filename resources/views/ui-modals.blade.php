                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                                                        <button type="submit" data-submit-protect="true" class="btn btn-primary">Submit</button>
                                                    </div>
                                                </div><!--end col-->
                                            </div><!--end row-->
                                        </form>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img loading="lazy" src="{{ URL::asset('build/images/modals/success-payment.png') }}" alt="Mac Image"
                                        class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img loading="lazy" src="{{ URL::asset('build/images/modals/login.png') }}" alt="Mac Image"
                                        class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-content border-0 overflow-hidden">
                                ...
                                <div class="modal-body p-5">
                                    ...
                                    <form>
                                        ...
                                        <button type="submit" data-submit-protect="true" class="btn btn-primary w-100">Submit</button>
                                    </form>
                                </div>
                            </div><!-- /.modal-content -->
                        </div><!-- /.modal-dialog -->
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img loading="lazy" src="{{ URL::asset('build/images/modals/subscribe.png') }}" alt="Mac Image"
                                        class="img-fluid">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="subscribe-modals-cover h-100">
                                            <img loading="lazy" src="{{ URL::asset('build/images/modals/auth-one-bg.jpg') }}" alt="" class="h-100 w-100 object-fit-cover" style="clip-path: polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%);">
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.modal-content -->
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img loading="lazy" src="{{ URL::asset('build/images/modals/signup.png') }}" alt="Mac Image"
                                        class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-content border-0 overflow-hidden">
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="text-end">
                                            <button type="submit" data-submit-protect="true" class="btn btn-primary">Sign Up Now</button>
                                        </div>
                                    </form>
                                </div>
                            </div><!-- /.modal-content -->
