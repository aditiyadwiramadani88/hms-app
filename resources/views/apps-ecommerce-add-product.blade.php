        ...
        <div class="row">
            <div class="col-lg-8">
                                    ...
                                    <div class="position-relative d-inline-block">
                                        ...
                                        <div class="avatar-lg">
                                            <div class="avatar-title bg-light rounded">
                                                <img loading="lazy" src="" id="product-img" class="avatar-md h-auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex p-2">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar-sm bg-light rounded">
                                                        <img loading="lazy" data-dz-thumbnail class="img-fluid rounded d-block" src="#" alt="Product-Image" />
                                                    </div>
                                                </div>
                    ...
                    <div class="text-end mb-3">
                        <button type="submit" data-submit-protect="true" class="btn btn-success w-sm">Submit</button>
                    </div>
            </div>
            <!-- end col -->
