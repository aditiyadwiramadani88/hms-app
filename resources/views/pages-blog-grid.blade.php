...
@section('content')
    ...
    <div class="row">
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img loading="lazy" src="{{ URL::asset('build/images/blog/img-1.jpg') }}" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img loading="lazy" src="{{ URL::asset('build/images/blog/img-2.jpg') }}" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img loading="lazy" src="{{ URL::asset('build/images/blog/img-3.jpg') }}" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img loading="lazy" src="{{ URL::asset('build/images/blog/img-4.jpg') }}" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img loading="lazy" src="{{ URL::asset('build/images/blog/img-5.jpg') }}" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                <div class="position-relative overflow-hidden">
                    <img loading="lazy" src="{{ URL::asset('build/images/blog/img-6.jpg') }}" alt="" class="blog-img object-fit-cover">
                </div>
                <div class="card-body">
