    ...
    <div class="file-manager-sidebar">
        <div class="p-4 d-flex flex-column h-100">
            ...
            <div class="mt-auto text-center">
                <img loading="lazy" src="{{URL::asset('build/images/task.png')}}" alt="Task" class="img-fluid" />
            </div>
        </div>
    </div>
    <!--end side content-->
            ...
            <div class="modal-body">
                <form autocomplete="off" class="needs-validation createProject-form" novalidate>
                    ...
                    <div class="hstack gap-2 justify-content-end">
                        ...
                        <button type="submit" data-submit-protect="true" class="btn btn-primary" id="addNewProject">Add Project</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-body">
                ...
                <form autocomplete="off" action="" id="creattask-form">
                                ...
                                <div data-simplebar style="max-height: 141px">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img loading="lazy" src="{{URL::asset('build/images/users/avatar-1.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img loading="lazy" src="{{URL::asset('build/images/users/avatar-10.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img loading="lazy" src="{{URL::asset('build/images/users/avatar-6.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img loading="lazy" src="{{URL::asset('build/images/users/avatar-9.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
                    ...
                    <div class="hstack gap-2 justify-content-end">
                        ...
                        <button type="submit" data-submit-protect="true" class="btn btn-primary" id="addNewTodo">Add Task</button>
                    </div>
                </form>
            </div>
        </div>
