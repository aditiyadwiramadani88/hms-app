                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-warning-subtle rounded p-2">
                                        <img loading="lazy" src="{{ URL::asset('build/images/brands/slack.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                            ...
                            <div class="avatar-group">
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                    ...
                                    <div class="avatar-xxs">
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" alt="" class="rounded-circle img-fluid">
                                    </div>
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-danger-subtle rounded p-2">
                                        <img loading="lazy" src="{{ URL::asset('build/images/brands/dribbble.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-success-subtle rounded p-2">
                                        <img loading="lazy" src="{{ URL::asset('build/images/brands/mail_chimp.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-info-subtle rounded p-2">
                                        <img loading="lazy" src="{{ URL::asset('build/images/brands/dropbox.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                ...
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-secondary-subtle rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img loading="lazy" src="{{ URL::asset('build/images/brands/dribbble.png') }}" alt="" height="32">
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-light rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img loading="lazy" src="{{ URL::asset('build/images/brands/slack.png') }}" alt="" height="32">
                        </div>
                    </div>
                    <div class="py-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-primary-subtle rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img loading="lazy" src="{{ URL::asset('build/images/brands/dropbox.png') }}" alt="" height="32">
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-danger-subtle rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img loading="lazy" src="{{ URL::asset('build/images/brands/mail_chimp.png') }}" alt="" height="32">
                        </div>
                    </div>
