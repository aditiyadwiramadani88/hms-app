        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Add Room Type</h5>
                </div>
                <div class="card-body">
                    <form method="POST" data-ajax="true" action="{{ route('room-types.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <button type="submit" data-submit-protect="true" class="btn btn-primary">Create</button>
