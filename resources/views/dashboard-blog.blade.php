                        ...
                        <table class="table table-hover table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>01</td>
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/blog/img-2.jpg') }}" alt=""
                                ...
                                <tr>
                                    <td>02</td>
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/blog/img-3.jpg') }}" alt=""
                                            class="me-2 rounded" height="40">
                                ...
                                <tr>
                                    <td>03</td>
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/blog/img-4.jpg') }}" alt=""
                                            class="me-2 rounded" height="40">
                                ...
                                <tr>
                                    <td>04</td>
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/blog/img-5.jpg') }}" alt=""
                                            class="me-2 rounded" height="40">
                                ...
                                <tr>
                                    <td>05</td>
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/blog/img-6.jpg') }}" alt=""
                                            class="me-2 rounded" height="40">
