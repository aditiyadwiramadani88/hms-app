                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/brands/dribbble.png') }}"
                                                        alt=""
                                ...
                                <form class="tablelist-form" autocomplete="off">
                                                    ...
                                                    <div class="position-relative d-inline-block">
                                                        ...
                                                        <div class="avatar-lg p-1">
                                                            <div class="avatar-title bg-light rounded-circle">
                                                                <img loading="lazy" src="{{ URL::asset('build/images/users/multi-user.jpg') }}"
                                    ...
                                    <div class="modal-footer">
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <button type="submit" data-submit-protect="true" class="btn btn-success" id="add-btn">Add
                                                Company</button>
            ...
            <div class="card" id="company-view-detail">
                <div class="card-body text-center">
                    <div class="position-relative d-inline-block">
                        <div class="avatar-md">
                            <div class="avatar-title bg-light rounded-circle">
                                <img loading="lazy" src="{{ URL::asset('build/images/brands/mail_chimp.png') }}" alt=""
