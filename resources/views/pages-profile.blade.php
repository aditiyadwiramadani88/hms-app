...
@section('content')
    ...
    <div class="profile-foreground position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg">
            <img loading="lazy" src="{{ URL::asset('build/images/profile-bg.jpg') }}" alt="" class="profile-wid-img" />
        </div>
    </div>
    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
                    <img loading="lazy" src="@if (Auth::user()->avatar != '') {{ URL::asset('images/' . Auth::user()->avatar) }}@else{{ URL::asset('build/images/users/avatar-1.jpg') }} @endif" alt="user-img" class="img-thumbnail rounded-circle" />
                </div>
            </div>
            <!--end col-->
            <div class="col">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt="" height="50"
                                                    class="rounded" />
                                            </div>
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-5.jpg') }}" alt="" height="50"
                                                    class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-6.jpg') }}" alt="" height="50"
                                                    class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="row mt-2">
                                                                                <div class="col-xxl-6">
                                                                                    <div
                                                                                        ...
                                                                                        <div class="col-3">
                                                                                            <img loading="lazy" src="{{ URL::asset('build/images/small/img-3.jpg') }}"
                                                                                                alt=""
                                                                                                class="img-fluid rounded" />
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img loading="lazy" src="{{ URL::asset('build/images/small/img-5.jpg') }}"
                                                                                                alt=""
                                                                                                class="img-fluid rounded" />
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img loading="lazy" src="{{ URL::asset('build/images/small/img-7.jpg') }}"
                                                                                                alt=""
                                                                                                class="img-fluid rounded" />
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img loading="lazy" src="{{ URL::asset('build/images/small/img-9.jpg') }}"
                                                                                                alt=""
                                                                                                class="img-fluid rounded" />
                                                                                        </div>
                                                                                        <!--end col-->
                                            ...
                                            <div class="row">
                                                <div class="col-xxl-4">
                                                    <div class="row border border-dashed gx-2 p-2 mb-2">
                                                        <div class="col-4">
                                                            <img loading="lazy" src="{{ URL::asset('build/images/small/img-2.jpg') }}" alt=""
                                                                class="img-fluid rounded" />
                                                        </div>
                                                        <!--end col-->
                                                        <div class="col-4">
                                                            <img loading="lazy" src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt=""
                                                                class="img-fluid rounded" />
                                                        </div>
                                                        <!--end col-->
                                                        <div class="col-4">
                                                            <img loading="lazy" src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt=""
                                                                class="img-fluid rounded" />
                                                        </div>
                                                        <!--end col-->
                                                    </div>
