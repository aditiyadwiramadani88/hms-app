                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#leadDiscovered1" role="button"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#leadDiscovered3"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#leadDiscovered4"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <h6 class="fs-13 mb-1">Airbnb React Development</h6>
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated1"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated2"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/brands/github.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated3"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated4"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated5"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/brands/mail_chimp.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified3"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/brands/dribbble.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified6"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/companies/img-6.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged1"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/companies/img-5.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged3"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/companies/img-8.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted2" role="button"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/brands/slack.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted5" role="button"
                            ...
                            <div class="flex-shrink-0">
                                <img loading="lazy" src="{{ URL::asset('build/images/companies/img-3.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
            ...
            <div class="modal-content">
                ...
                <form class="needs-validation" novalidate id="deals-form" onsubmit="return false">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" data-submit-protect="true" class="btn btn-success"><i class="ri-save-line align-bottom me-1"></i>
                            Save</button>
                    </div>
                </form>
            </div>
