            ...
            <form class="needs-validation" novalidate id="invoice_form">
                            ...
                            <div class="profile-user mx-auto  mb-3">
                                ...
                                <label for="profile-img-file-input" class="d-block" tabindex="0">
                                    <span class="overflow-hidden border border-dashed d-flex align-items-center justify-content-center rounded" style="height: 60px; width: 256px;">
                                        <img loading="lazy" src="{{ URL::asset('build/images/logo-dark.png') }}" class="card-logo card-logo-dark user-profile-image img-fluid" alt="logo dark">
                                        <img loading="lazy" src="{{ URL::asset('build/images/logo-light.png') }}" class="card-logo card-logo-light user-profile-image img-fluid" alt="logo light">
                                    </span>
                                </label>
                            </div>
                            <div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                        <button type="submit" data-submit-protect="true" class="btn btn-success"><i class="ri-printer-line align-bottom me-1"></i> Save</button>
