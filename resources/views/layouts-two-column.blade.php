                        ...
                        <table class="table table-nowrap table-centered align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                        ...
                                        <div class="avatar-group flex-nowrap">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-6.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-7.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-8.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-6.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            ...
                                            <div class="avatar-group-item">
                                                <a href="javascript: void(0);" class="d-inline-block">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                </a>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div class="table-responsive table-card">
                        <table class="table table-borderless table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="d-flex">
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                ...
                <div class="card-body p-0">
                                                ...
                                                <div class="message-img-list">
                                                    <div>
                                                        <a class="popup-img d-inline-block" href="{{ URL::asset('build/images/small/img-1.jpg') }}">
                                                            <img loading="lazy" src="{{ URL::asset('build/images/small/img-1.jpg') }}" alt="" class="rounded border">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="message-img-list">
                                                    <div>
                                                        <a class="popup-img d-inline-block" href="{{ URL::asset('build/images/small/img-2.jpg') }}">
                                                            <img loading="lazy" src="{{ URL::asset('build/images/small/img-2.jpg') }}" alt="" class="rounded border">
                                                        </a>
                                                    </div>
                                                    <div class="message-img-link">
                                                        <ul class="list-inline mb-0">
                    ...
                    <div class="border-top border-top-dashed">
                        <div class="row g-2 mx-3 mt-2 mb-3">
                            ...
                            <div class="col-auto">
                                <button type="submit" data-submit-protect="true" class="btn btn-info"><span class="d-none d-sm-inline-block me-2">Send</span> <i class="mdi mdi-send float-end"></i></button>
                            </div><!-- end col -->
                        </div><!-- end row -->
                    </div>
                </div><!-- end cardbody -->
