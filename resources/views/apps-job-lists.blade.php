...
<div class="row">
    ...
    <div class="col-xxl-3">
        <div class="card job-list-view-card overflow-hidden" id="job-overview">
            <img loading="lazy" src="{{URL::asset('build/images/small/img-10.jpg')}}" alt="" id="cover-img" class="img-fluid background object-fit-cover">
            <div class="card-body">
                <div class="avatar-md mt-n5">
                    <div class="avatar-title bg-light rounded-circle">
                        <img loading="lazy" src="{{URL::asset('build/images/companies/img-7.png')}}" alt="" class="avatar-xs view-companylogo">
                    </div>
                </div>
                <div class="mt-3">
            ...
            <form id="createjob-form" autocomplete="off" class="needs-validation" novalidate>
                        ...
                        <div class="col-lg-12">
                            <div class="px-1 pt-1">
                                <div class="modal-team-cover position-relative mb-0 mt-n4 mx-n4 rounded-top overflow-hidden">
                                    <img loading="lazy" src="{{URL::asset('build/images/small/img-9.jpg')}}" alt="" id="modal-cover-img" class="img-fluid">
                            ...
                            <div class="text-center mb-4 mt-n5 pt-2">
                                <div class="position-relative d-inline-block">
                                    ...
                                    <div class="avatar-lg p-1">
                                        <div class="avatar-title bg-light rounded-circle">
                                            <img loading="lazy" src="{{URL::asset('build/images/users/multi-user.jpg')}}" id="companylogo-img" class="avatar-md rounded-circle object-fit-cover" />
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <div class="hstack gap-2 justify-content-end">
                        ...
                        <button type="submit" data-submit-protect="true" class="btn btn-success" id="add-btn">Add Job</button>
                    </div>
                </div>
            </form>
        </div>
