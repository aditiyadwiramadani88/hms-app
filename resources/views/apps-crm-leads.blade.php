                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-10.jpg') }}" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">
                                            </div>
                            ...
                            <form class="tablelist-form" autocomplete="off">
                                                ...
                                                <div class="position-relative d-inline-block">
                                                    ...
                                                    <div class="avatar-lg p-1">
                                                        <div class="avatar-title bg-light rounded-circle">
                                                            <img loading="lazy" src="{{ URL::asset('build/images/users/user-dummy-img.jpg') }}" alt="" id="lead-img" class="avatar-md rounded-circle object-fit-cover">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-footer">
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" data-submit-protect="true" class="btn btn-success" id="add-btn">Add leads</button>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                    ...
                    <form action="" class="d-flex flex-column justify-content-end h-100">
                        ...
                        <div class="offcanvas-footer border-top p-3 text-center hstack gap-2">
                            ...
                            <button type="submit" data-submit-protect="true" class="btn btn-success w-100">Filters</button>
                        </div>
