    ...
    <div class="row">
        <div class="col-lg-8">
                                    ...
                                    <div class="d-flex p-2">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar-sm bg-light rounded">
                                                <img loading="lazy" src="#" alt="Project-Image" data-dz-thumbnail
            ...
            <div class="text-end mb-4">
                <button type="submit" data-submit-protect="true" class="btn btn-danger w-sm">Delete</button>
                <button type="submit" data-submit-protect="true" class="btn btn-secondary w-sm">Draft</button>
                <button type="submit" data-submit-protect="true" class="btn btn-success w-sm">Create</button>
            </div>
        </div>
        <!-- end col -->
        <div class="col-lg-4">
