                            ...
                            <div class="product-img-slider sticky-side-div">
                                <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img loading="lazy" src="{{ URL::asset('build/images/products/img-8.png') }}" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img loading="lazy" src="{{ URL::asset('build/images/products/img-6.png') }}" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img loading="lazy" src="{{ URL::asset('build/images/products/img-1.png') }}" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img loading="lazy" src="{{ URL::asset('build/images/products/img-8.png') }}" alt="" class="img-fluid d-block" />
                                        </div>
                                ...
                                <div class="swiper product-nav-slider mt-2">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="nav-slide-item">
                                                <img loading="lazy" src="{{ URL::asset('build/images/products/img-1.png') }}" alt=""
                                                    class="img-fluid d-block" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
