    ...
    <div class="col-xxl-9">
        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-1.gif" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-5.gif" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-03.jpg')}}" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-4.gif" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-3.gif" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-04.jpg')}}" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-05.jpg')}}" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-02.jpg')}}" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/users/avatar-1.jpg')}}" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/users/avatar-3.jpg')}}" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/users/avatar-5.jpg')}}" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/users/avatar-10.jpg')}}" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/users/avatar-8.jpg')}}" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
