                    ...
                    <div class="row justify-content-center mb-4">
                        <div class="col-lg-6">
                            <div class="row g-2">
                                ...
                                <div class="col-auto">
                                    <button type="submit" data-submit-protect="true" class="btn btn-primary btn-lg waves-effect waves-light"><i
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="{{ URL::asset('build/images/small/img-1.jpg') }}" class="image-popup d-block">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-1.jpg') }}" alt=""
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="search-more-results rounded">
                                                    <a href="javascript:void(0);" onclick="myFunction()"
                                                        class="d-block">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-5.jpg') }}" alt=""
                                                            class="img-fluid d-block rounded" />
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-12.jpg') }}" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-11.jpg') }}" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-10.jpg') }}" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-9.jpg') }}" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-8.jpg') }}" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-7.jpg') }}" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-6.jpg') }}" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-5.jpg') }}" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img loading="lazy" src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" width="65"
                                                            class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="javascript:void(0);"
                                        ...
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('build/images/small/img-1.jpg') }}" title="">
                                                    <img loading="lazy" class="gallery-img img-fluid mx-auto"
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/small/img-1.jpg') }}" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/small/img-2.jpg') }}" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/small/img-5.jpg') }}" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/small/img-6.jpg') }}" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/small/img-7.jpg') }}" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/small/img-8.jpg') }}" alt="" width="115"
                                                        class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
