                                ...
                                <li class="list-group-item" data-id="1">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img loading="lazy" class="image avatar-xs rounded-circle" alt=""
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        <div class="hstack gap-2 justify-content-end">
                            ...
                            <button type="submit" data-submit-protect="true" class="btn btn-success" id="add-btn">Add Customer</button>
