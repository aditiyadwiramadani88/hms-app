                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index" class="d-block">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/logo-light.png') }}" alt="" height="18">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="user-thumb text-center">
                                            <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="rounded-circle img-thumbnail avatar-lg" alt="thumbnail">
                                        ...
                                        <div class="mt-4">
                                            <form>
                                                ...
                                                <div class="mb-2 mt-4">
                                                    <button class="btn btn-success w-100" type="submit" data-submit-protect="true">Unlock</button>
                                                </div>
                                            </form><!-- end form -->
                                        </div>
