                        ...
                        <div class="mt-2 vstack email-chat-list mx-n4">
                            <a href="javascript: void(0);" class="d-flex align-items-center active">
                                <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                    <img loading="lazy" class="img-fluid rounded-circle" src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" alt="">
                                </div>
                            ...
                            <a href="javascript: void(0);" class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                    <img loading="lazy" class="img-fluid rounded-circle" src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="">
                                </div>
                            ...
                            <a href="javascript: void(0);" class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                    <img loading="lazy" class="img-fluid rounded-circle" src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" alt="">
                                </div>
                            ...
                            <a href="javascript: void(0);" class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                    <img loading="lazy" class="img-fluid rounded-circle" src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="">
                                </div>
            ...
            <div class="card-body p-0">
                ...
                <div class="border-top border-top-dashed">
                    <div class="row g-2 mx-3 mt-2 mb-3">
                        ...
                        <div class="col-auto">
                            <button type="submit" data-submit-protect="true" class="btn btn-info"><i class="mdi mdi-send"></i></button>
                        </div><!-- end col -->
                    </div><!-- end row -->
                </div>
            </div><!-- end cardbody -->
