                                ...
                                <tr>
                                    ...
                                    <td class="company">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img loading="lazy" src="{{URL::asset('build/images/brands/slack.png')}}" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">
                                            </div>
                            ...
                            <form class="tablelist-form" autocomplete="off">
                                        ...
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <div class="avatar-lg p-1">
                                                <div class="avatar-title bg-light rounded-circle">
                                                    <img loading="lazy" src="{{URL::asset('build/images/users/multi-user.jpg')}}" id="companylogo-img" class="avatar-md h-auto rounded-circle object-fit-cover" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" data-submit-protect="true" class="btn btn-success" id="add-btn">Add</button>
