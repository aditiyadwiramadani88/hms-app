                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-md p-4">
                                    <form>
                                        ...
                                        <button type="submit" data-submit-protect="true" class="btn btn-primary">Sign in</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="tab-content" id="notificationItemsTabContent4">
                                        ...
                                        <div class="tab-pane fade p-4" id="alerts-tab1" role="tabpanel"
                                            ...
                                            <div class="w-25 pt-3 mx-auto">
                                                <img loading="lazy" src="{{ URL::asset('build/images/svg/bell.svg') }}" class="img-fluid"
                                                    alt="user-pic">
                                            </div>
