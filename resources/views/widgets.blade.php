        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-height-100">
                <div class="card-body">
                    ...
                    <div class="mb-4 pb-2">
                        <img loading="lazy" src="{{ URL::asset('build/images/companies/img-3.png') }}" alt="" class="avatar-sm">
                    </div>
                    <a href="#!">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-height-100">
                <div class="card-body">
                    ...
                    <div class="mb-4 pb-2">
                        <img loading="lazy" src="{{ URL::asset('build/images/companies/img-4.png') }}" alt="" class="avatar-sm">
                    </div>
                    <a href="#!">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-height-100 bg-primary-subtle shadow-none bg-opacity-10">
                <div class="card-body">
                    ...
                    <div class="mb-4 pb-2">
                        <img loading="lazy" src="{{ URL::asset('build/images/companies/img-6.png') }}" alt="" class="avatar-sm">
                    </div>
                    <a href="#!">
                        <h6 class="fs-15 fw-semibold">Sr. Web Designer <span class="text-muted fs-13">(2+ Yrs Exp.)</span>
                        </h6>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-height-100 bg-info-subtle shadow-none bg-opacity-10">
                <div class="card-body">
                    ...
                    <div class="mb-4 pb-2">
                        <img loading="lazy" src="{{ URL::asset('build/images/companies/img-8.png') }}" alt="" class="avatar-sm">
                    </div>
                    <a href="#!">
                        <h6 class="fs-15 fw-semibold">Sr. Web Designer <span class="text-muted fs-13">(2+ Yrs Exp.)</span>
                        </h6>
            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-sm-4">
                            <div class="px-3">
                                <img loading="lazy" src="{{ URL::asset('build/images/user-illustarator-2.png') }}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="card bg-primary">
                <div class="card-body p-0">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-sm-4">
                            <div class="px-3">
                                <img loading="lazy" src="{{ URL::asset('build/images/user-illustarator-1.png') }}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="avatar-group">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-1.jpg') }}"
                                        ...
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-2.jpg') }}"
                                                    alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-3.jpg') }}"
                                                    alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                    ...
                                    <div class="avatar-group">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-4.jpg') }}"
                                                    alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-5.jpg') }}"
                                                    alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-6.jpg') }}"
                                                    alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-7.jpg') }}"
                                                    alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                    ...
                                    <div class="avatar-group">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-8.jpg') }}"
                                                    alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2 w-75">
                                                <a href="apps-ecommerce-product-details" class="bg-light rounded p-1">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/products/img-8.png') }}"
                                                        alt="" class="img-fluid d-block" />
                                                </a>
                                                <a href="apps-ecommerce-product-details" class="bg-light rounded p-1">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/products/img-2.png') }}"
                                                        alt="" class="img-fluid d-block" />
                                                </a>
                                                <a href="apps-ecommerce-product-details" class="bg-light rounded p-1">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/products/img-10.png') }}"
                                                        alt="" class="img-fluid d-block" />
                                                </a>
                                            </div>
                    ...
                    <ul class="list-group list-group-flush border-dashed mb-0">
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img loading="lazy" src="{{ URL::asset('build/images/svg/crypto-icons/eth.svg') }}"
                                            class="img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="flex-grow-1 ms-2">
                            ...
                            <div class="swiper-slide" style="max-width: 200px;">
                                <div>
                                    <div class="bg-info-subtle rounded">
                                        <img loading="lazy" src="{{ URL::asset('build/images/products/img-3.png') }}" alt=""
                            ...
                            <div class="swiper-slide" style="max-width: 200px;">
                                <div>
                                    <div class="bg-success-subtle rounded">
                                        <img loading="lazy" src="{{ URL::asset('build/images/products/img-4.png') }}" alt=""
                                            style="max-height: 210px;max-width: auto;" />
                                    </div>
                                    <div class="pt-3">
                                        <h5 class="text-secondary">$99.94</h5>
                            ...
                            <div class="swiper-slide" style="max-width: 200px;">
                                <div>
                                    <div class="bg-warning-subtle rounded">
                                        <img loading="lazy" src="{{ URL::asset('build/images/products/img-5.png') }}" alt=""
                                            style="max-height: 210px;max-width: auto;" />
                                    </div>
                                    <div class="pt-3">
                                        <h5 class="text-secondary">$99.94</h5>
                            ...
                            <div class="swiper-slide" style="max-width: 200px;">
                                <div>
                                    <div class="bg-secondary-subtle rounded">
                                        <img loading="lazy" src="{{ URL::asset('build/images/products/img-6.png') }}" alt=""
                                            style="max-height: 210px;max-width: auto;" />
                                    </div>
                                    <div class="pt-3">
                                        <h5 class="text-secondary">$99.94</h5>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="avatar-sm me-3 flex-shrink-0">
                            <div class="avatar-title bg-danger-subtle rounded">
                                <img loading="lazy" src="{{ URL::asset('build/images/products/img-8.png') }}" alt=""
                                    class="avatar-xs">
                            </div>
                        </div>
                        <div class="flex-grow-1">
            ...
            <div class="card card-height-100 ">
                ...
                <div class="card-body">
                    ...
                    <form id="custom-card-form" autocomplete="off">
                        ...
                        <button class="btn btn-danger w-100 mt-3" type="submit" data-submit-protect="true">Pay Now</button>
                    </form>
                    <!-- end card form elem -->
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-container active">
                        <form action="" id="card-form-elem" autocomplete="off">
                            ...
                            <button class="btn btn-danger w-100" type="submit" data-submit-protect="true">Pay Now</button>
                        </form>
                    </div>
                </div>
                <!-- end card-body -->
