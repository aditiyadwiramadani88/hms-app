                ...
                <div class="card-body">
                    ...
                    <div class="swiper navigation-swiper rounded">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-6.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="swiper pagination-dynamic-swiper rounded">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-7.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-8.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-9.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="swiper pagination-fraction-swiper rounded">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-10.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-11.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-12.jpg') }}" alt=""
                                    class="img-fluid" />
                            </div>
                        </div>
                        <div class="swiper-button-next"></div>
