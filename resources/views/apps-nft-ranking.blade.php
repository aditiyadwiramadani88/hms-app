                    ...
                    <table class="table align-middle table-nowrap table-hover" id="customerTable">
                        ...
                        <tbody class="list form-check-all">
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-01.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Abstract face painting</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-1.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Patterns arts & culture</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-02.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Creative filtered portrait</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-2.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Long-tailed macaque</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-04.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Robotic Body Art</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-06.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Smillevers Crypto</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-5.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">The Chirstoper</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-3.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Walking on air</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-05.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">The Chirstoper</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-03.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Walking on air</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{URL::asset('build/images/nft/img-04.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Highstreet IHO Part</a>
                                    </div>
                                </td>
