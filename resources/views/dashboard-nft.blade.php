                ...
                <div class="col-xl-6">
                    <div class="card overflow-hidden">
                        <div class="card-body bg-marketplace d-flex">
                            ...
                            <img loading="lazy" src="{{ URL::asset('build/images/bg-d.png') }}" alt="" class="img-fluid" />
                        </div>
                    </div>
                </div>
                <!--end col-->
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-xxl-4">
                                    <div class="border-start p-4 h-100 d-flex flex-column">
                                        ...
                                        <div class="w-100">
                                            <div class="d-flex align-items-center">
                                                <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-2.gif"
                    ...
                    <div class="table-responsive table-card">
                        <div data-simplebar style="max-height: 365px;">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{ URL::asset('build/images/nft/img-01.jpg') }}" alt=""
                                            class="avatar-xs object-fit-cover rounded-circle">
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{ URL::asset('build/images/nft/img-04.jpg') }}" alt=""
                                            class="avatar-xs object-fit-cover rounded-circle">
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{ URL::asset('build/images/nft/img-06.jpg') }}" alt=""
                                            class="avatar-xs object-fit-cover rounded-circle">
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{ URL::asset('build/images/nft/img-03.jpg') }}" alt=""
                                            class="avatar-xs object-fit-cover rounded-circle">
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                ...
                                <li class="list-group-item list-group-item-action">
                                    <div class="d-flex align-items-center">
                                        <img loading="lazy" src="{{ URL::asset('build/images/nft/img-05.jpg') }}" alt=""
                                            class="avatar-xs object-fit-cover rounded-circle">
                                        <div class="ms-3 flex-grow-1">
                                            <a href="#!">
                                                <h6 class="fs-14 mb-1">Timothy Smith</h6>
            ...
            <div class="swiper marketplace-swiper rounded gallery-light">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            <div class="explore-place-bid-img">
                                <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-3.gif" alt=""
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            <div class="explore-place-bid-img">
                                <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                                    class="img-fluid card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            <div class="explore-place-bid-img">
                                <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-4.gif" alt=""
                                    class="img-fluid card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i
                            ...
                            <table class="table table-borderless align-middle">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img loading="lazy" src="{{ URL::asset('build/images/nft/img-02.jpg') }}" alt=""
                                                    class="avatar-sm rounded-circle">
                                                <div class="ms-3">
                                                    <a href="#!">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-5.gif"
                        ...
                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img loading="lazy" src="{{ URL::asset('build/images/svg/crypto-icons/btc.svg') }}"
                                ...
                                <tr>
                                    ...
                                    <td><img loading="lazy" src="{{ URL::asset('build/images/svg/crypto-icons/ltc.svg') }}"
                                ...
                                <tr>
                                    ...
                                    <td><img loading="lazy" src="{{ URL::asset('build/images/svg/crypto-icons/etc.svg') }}"
                                ...
                                <tr>
                                    ...
                                    <td><img loading="lazy" src="{{ URL::asset('build/images/svg/crypto-icons/dash.svg') }}"
                                ...
                                <tr>
                                    ...
                                    <td><img loading="lazy" src="{{ URL::asset('build/images/svg/crypto-icons/bnb.svg') }}"
                                ...
                                <tr>
                                    ...
                                    <td><img loading="lazy" src="{{ URL::asset('build/images/svg/crypto-icons/usdt.svg') }}"
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-1">
                        <p class="mb-1"><img loading="lazy" src="{{ URL::asset('build/images/flags/us.svg') }}" alt=""
                                height="15" class="rounded me-2"> United States <span class="float-end">34%</span></p>
                        <p class="mb-1"><img loading="lazy" src="{{ URL::asset('build/images/flags/russia.svg') }}" alt=""
                                height="15" class="rounded me-2"> Russia <span class="float-end">27%</span></p>
                        <p class="mb-1"><img loading="lazy" src="{{ URL::asset('build/images/flags/spain.svg') }}" alt=""
                                height="15" class="rounded me-2"> Spain <span class="float-end">21%</span></p>
                        <p class="mb-1"><img loading="lazy" src="{{ URL::asset('build/images/flags/italy.svg') }}" alt=""
                                height="15" class="rounded me-2"> Italy <span class="float-end">13%</span></p>
                        <p class="mb-0"><img loading="lazy" src="{{ URL::asset('build/images/flags/germany.svg') }}" alt=""
                ...
                <div class="card-body">
                    <div class="swiper collection-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                    <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-5.gif" alt=""
                                        height="220" class="object-fit-cover w-100" />
                                    <div
                                        class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                        <div class="flex-grow-1">
