                                                ...
                                                <div class="w-100">
                                                    <div class="d-flex flex-column h-100">
                                                        @php
                                                            ...
                                                            $authLogoDark = $authHotel && $authHotel->logo_path
                                                                ? asset('storage/' . $authHotel->logo_path)
                                                                : URL::asset('build/images/logo-dark.png');
                                                            $authLogoLight = $authHotel && $authHotel->logo_light_path
                                                        ...
                                                        <div class="mb-4 mb-md-5">
                                                            <a href="index" class="d-block auth-logo">
                                                                <img loading="lazy" src="{{ $authLogoDark }}" alt="" height="22" class="auth-logo-dark me-start">
                                                                <img loading="lazy" src="{{ $authLogoLight }}" alt="" height="22" class="auth-logo-light me-start">
                                                            </a>
                                                        </div>
                    ...
                    <div class="col-xxl-8 col-lg-8 col-md-6">
                        <div class="auth-bg bg-white py-md-5 p-4 d-flex">
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-xl-8">
                                    <div class="mt-4">
                                        <img loading="lazy" src="{{URL::asset('build/images/login-img.png')}}" class="img-fluid" alt="">
                                    </div>
