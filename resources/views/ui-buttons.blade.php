                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <button class="btn btn-success waves-effect waves-light" type="submit" data-submit-protect="true">Button</button>
                                            <input class="btn btn-info" type="button" value="Input">
                                            <input class="btn btn-danger" type="submit" data-submit-protect="true" value="Submit">
