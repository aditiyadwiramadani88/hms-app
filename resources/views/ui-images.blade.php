                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <img loading="lazy" class="rounded" alt="200x200" width="200" src="{{ URL::asset('build/images/small/img-4.jpg') }}"
                                    data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-6">
                                <div class="mt-4 mt-md-0">
                                    <img loading="lazy" class="rounded-circle avatar-xl" alt="200x200"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <img loading="lazy" class="img-thumbnail" alt="200x200" width="200" src="{{ URL::asset('build/images/small/img-3.jpg') }}"
                                    data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-6">
                                <div class="mt-4 mt-md-0">
                                    <img loading="lazy" class="img-thumbnail rounded-circle avatar-xl" alt="200x200"
                            ...
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" alt="" class="rounded avatar-xxs">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xxs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-10.jpg') }}" alt="" class="rounded avatar-xs">
                                            <p class="mt-2 mb-lg-0"><code>avatar-xs</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" alt="" class="rounded avatar-sm">
                                            <p class="mt-2 mb-lg-0"><code>avatar-sm</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="" class="rounded avatar-md">
                                            <p class="mt-2  mb-lg-0"><code>avatar-md</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="rounded avatar-lg">
                                            <p class="mt-2 mb-lg-0"><code>avatar-lg</code></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-xxl-2 col-md-4 col-6">
                                        <div>
                                            <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-8.jpg') }}" alt="" class="rounded avatar-xl">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <figure class="figure mb-0">
                                    <img loading="lazy" src="{{ URL::asset('build/images/small/img-4.jpg') }}" class="figure-img img-fluid rounded"
                                        alt="...">
                            ...
                            <div class="col-sm-6">
                                <figure class="figure mb-0">
                                    <img loading="lazy" src="{{ URL::asset('build/images/small/img-5.jpg') }}" class="figure-img img-fluid rounded"
                                        alt="...">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div>
                            <img loading="lazy" src="{{ URL::asset('build/images/small/img-2.jpg') }}" class="img-fluid" alt="Responsive image">
                        </div>
