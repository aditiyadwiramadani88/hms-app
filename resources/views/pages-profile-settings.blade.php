...
@section('content')
    <div class="position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg profile-setting-img">
            <img loading="lazy" src="{{ URL::asset('build/images/profile-bg.jpg') }}" class="profile-wid-img" alt="">
                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                            <img loading="lazy" src="@if (Auth::user()->avatar != '') {{ URL::asset('images/' . Auth::user()->avatar) }}@else{{ URL::asset('build/images/users/avatar-1.jpg') }} @endif"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="hstack gap-2 justify-content-end">
                                            <button type="submit" data-submit-protect="true" class="btn btn-primary">Updates</button>
                        ...
                        <div class="tab-pane" id="changePassword" role="tabpanel">
                            <form action="javascript:void(0);">
                                <div class="row g-2">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="text-end">
                                            <button type="submit" data-submit-protect="true" class="btn btn-success">Change
                                                Password</button>
                                        </div>
                                    </div>
                                    <!--end col-->
                            ...
                            <form>
                                ...
                                <div class="col-lg-12">
                                    <div class="hstack gap-2">
                                        <button type="submit" data-submit-protect="true" class="btn btn-success">Update</button>
