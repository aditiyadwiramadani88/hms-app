                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="px-3">
                                            <img loading="lazy" src="{{ URL::asset('build/images/user-illustarator-2.png') }}" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end card-body-->
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <div class="text-center">
                                <img loading="lazy" src="{{ URL::asset('build/images/illustrator-1.png') }}" class="img-fluid" alt="">
                            </div>
                        </div><!-- end col -->
                    </div><!-- end row -->
                    <div class="mt-3 pt-2">
