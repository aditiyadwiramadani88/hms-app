            ...
            <div class="card">
                    ...
                    <div>
                        <div class="flex-shrink-0 avatar-md mx-auto">
                            <div class="avatar-title bg-light rounded">
                                <img loading="lazy" src="{{ URL::asset('build/images/companies/img-2.png') }}" alt="" height="50" />
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-sm">
                                                <div class="avatar-title bg-light rounded">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/companies/img-1.png') }}" alt="" height="30">
                                                </div>
                                            </div>
                                ...
                                <div class="card border border-dashed shadow-none">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-sm">
                                                <div class="avatar-title bg-light rounded">
                                                    <img loading="lazy" src="{{ URL::asset('build/images/companies/img-8.png') }}" alt="" height="30">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <div>
                ...
                <div class="card-body p-4 border-top border-top-dashed">
                    ...
                    <form action="#">
                        ...
                        <div class="text-end">
                            <button type="submit" data-submit-protect="true" class="btn btn-primary"><i
