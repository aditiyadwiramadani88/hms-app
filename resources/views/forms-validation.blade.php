                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <form class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary" type="submit" data-submit-protect="true">Submit form</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="live-preview">
                            <form class="was-validated">
                                ...
                                <div class="mb-0">
                                    <button class="btn btn-primary" type="submit" data-submit-protect="true" disabled>Submit form</button>
                                </div>
                            </form>
                        </div>
