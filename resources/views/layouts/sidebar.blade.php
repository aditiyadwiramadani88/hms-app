            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMasterData" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-data"></i> <span>Master Data</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarMasterData">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('employees.index') }}" class="nav-link">Pegawai</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('guest-categories.index') }}" class="nav-link">Kategori Tamu</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('suppliers.index') }}" class="nav-link">Supplier</a>
                            </li>
                             <li class="nav-item">
                                <a href="{{ route('room-rates.index') }}" class="nav-link">Tarif Kamar</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAssets" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="bx bx-buildings"></i> <span>Asset Management</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarProcurement" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarProcurement">
                        <i class="bx bx-shopping-bag"></i> <span>Procurement</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarProcurement">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('purchases.index') }}" class="nav-link">Daftar Pembelian</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('shift-handovers.index') }}">
                        <i class="ri-exchange-line"></i>
                        <span>Serah Terima</span>
                        @if(isset($pendingHandovers) && $pendingHandovers > 0)
                            <span class="badge bg-danger rounded-circle">{{ $pendingHandovers }}</span>
                        @endif
                    </a>
                </li>
                @endcanany
