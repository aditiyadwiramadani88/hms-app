                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="row g-2 mb-3">
                                            ...
                                            <div class="col-lg-1 col-sm-2 col-6">
                                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-5.jpg') }}" alt="" class="img-fluid rounded">
                                            </div>
                                        </div>
                                        <a href="javascript: void(0);" class="badge text-muted bg-light"><i
                                                class="mdi mdi-reply"></i> Reply</a>
                    ...
                    <div class="mb-4 d-flex align-items-center">
                        ...
                        <div class="avatar-group justify-content-center">
                            ...
                            <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                ...
                                <div class="avatar-xs">
                                    <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-8.jpg') }}" alt="" class="rounded-circle img-fluid">
                                </div>
                            </a>
                            <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
