                            ...
                            <div class="mx-n3">
                                <div data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="primary"
                                    ...
                                    <a href="#!" class="text-reset notification-item d-block dropdown-item active">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="rounded-circle img-fluid"
                                                    alt="user-pic">
                                            </div>
                                            <div class="flex-grow-1 text-muted">
                                    ...
                                    <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-8.jpg') }}" class="rounded-circle img-fluid"
                                                    alt="user-pic">
                                            </div>
                                            <div class="flex-grow-1 text-muted">
