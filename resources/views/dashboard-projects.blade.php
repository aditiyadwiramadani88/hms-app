                        ...
                        <table class="table table-nowrap table-centered align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-xxs rounded-circle me-1"
                                            alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-xxs rounded-circle me-1"
                                            alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" class="avatar-xxs rounded-circle me-1"
                                            alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" class="avatar-xxs rounded-circle me-1"
                                            alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img loading="lazy" src="{{ URL::asset('build/images/users/avatar-6.jpg') }}" class="avatar-xxs rounded-circle me-1"
                                            alt="">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="border-top border-top-dashed">
                        <div class="row g-2 mx-3 mt-2 mb-3">
                            ...
                            <div class="col-auto">
                                <button type="submit" data-submit-protect="true" class="btn btn-info"><span
