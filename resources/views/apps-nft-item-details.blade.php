                                        ...
                                        <table class="table align-middle table-nowrap mb-0">
                                            <tbody>
                                                <tr>
                                                    <th scope="row">
                                                        <div class="d-flex align-items-center">
                                                            <img loading="lazy" src="{{ URL::asset('build/images/nft/img-01.jpg') }}"
                                                                alt=""
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <div class="d-flex align-items-center">
                                                            <img loading="lazy" src="{{ URL::asset('build/images/nft/img-03.jpg') }}"
                                                                alt=""
                                                                class="avatar-xs rounded object-fit-cover" />
                                                            <a href="apps-nft-item-details" class="text-body"><span
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <div class="d-flex align-items-center">
                                                            <img loading="lazy" src="https://img.themesbrand.com/velzon/images/img-4.gif"
                                                                alt=""
                                                                class="avatar-xs rounded object-fit-cover" />
                                                            <a href="apps-nft-item-details" class="text-body"><span
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <div class="d-flex align-items-center">
                                                            <img loading="lazy" src="{{ URL::asset('build/images/nft/img-06.jpg') }}"
                                                                alt=""
                                                                class="avatar-xs rounded object-fit-cover" />
                                                    ...
                                                    <div class="border border-dashed rounded p-3">
                                                        ...
                                                        <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                            <a href="#" class="d-block">
                                                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-12.jpg') }}"
                                                                    alt=""
                                                                    class="avatar-sm rounded object-fit-cover" />
                                                            </a>
                                                            <a href="#" class="d-block">
                                                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-11.jpg') }}"
                                                                    alt=""
                                                                    class="avatar-sm rounded object-fit-cover" />
                                                            </a>
                                                            <a href="#" class="d-block">
                                                                <img loading="lazy" src="{{ URL::asset('build/images/small/img-10.jpg') }}"
                                                                    alt=""
                                                                    class="avatar-sm rounded object-fit-cover" />
                                                            </a>
                                                        </div>
